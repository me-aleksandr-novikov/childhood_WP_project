                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="footer__social">
                            ...
                            <a href="<?php the_field('ref_inst', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('ref_facebook', 2)?>" class="footer__social-item">
                            ...
                            <a href="<?php the_field('ref_youtube', 2)?>" class="footer__social-item">
