                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="toys__alert">
                            <span><?php the_field('text_invitation_head');?></span> 
                            <?php the_field('text_invitation');?>
                        </div>
                    </div>
                </div>
            </div>
